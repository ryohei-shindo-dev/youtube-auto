...
# --- 分析結果の読み込み ---
INSIGHTS_FILE = pathlib.Path(__file__).parent / "data" / "analytics" / "analytics_insights.json"
...
_RESOLVE_HISTORY_PATH = pathlib.Path(__file__).parent / "debug" / "resolve_history.json"
