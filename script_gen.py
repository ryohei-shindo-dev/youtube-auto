...
_LOOP_CLOSING_RESTRAIN = [
    ("もう、動きすぎなくていい。", "動きすぎなくていい"),
    ("また仕組みに戻ればいい。", "仕組みに戻ればいい"),
    ("崩さないだけでも、意味はある。", "崩さないだけでいい"),
    ("触りすぎない形に戻ればいい。", "触りすぎなくていい"),
    ("そのままでも、十分進んでいる。", "十分進んでいる"),
]
# 共通（どのタイプでも使える）
...
_RESOLVE_CONTINUE = [
    ...
    "つまり、淡々と続けた人が最後に笑う。",
    "やっぱり、地味な日こそ複利が効いている。",
    "結局、動かなかった勇気が資産を守っている。",
    "そう、退屈な投資が一番強い。",
    "だからこそ、今日も積み立てた。それだけで正解。",
]
# B群: 時間肯定系 — 「時間は味方」系（歴史データ系・具体数字系・メリット向き）
_RESOLVE_TIME = [
    "だから、時間が最大の武器。",
    "やっぱり、長期投資しかない。",
    "つまり、時間は静かに味方してくれる。",
    "だからこそ、10年後の自分が今日に感謝する。",
    "結局、市場にいた時間が全てを決める。",
    "そう考えると、長く持った人だけが見える景色がある。",
    "やっぱり、1年では見えない。10年なら見える。",
    "だから、急がない人ほど後で強い。",
]
...
_RESOLVE_CALM = [
    ...
    "結局、焦らない日が長期では効いてくる。",
    "やっぱり、売らない判断が資産を守る。",
    "だからこそ、怖い時こそ何もしないのが最適解。",
    "そう、不安は通り過ぎる。積み立ては残る。",
]
# D群: 暴落耐性系 — 「暴落は通過点」系（暴落テーマ・ガチホモチベ向き）
_RESOLVE_CRASH = [
    "やっぱり、暴落は長期投資家の味方。",
    "だから、暴落の翌年に最大のリターンが来る。",
    "つまり、下がる時期も積立の一部。",
    "結局、暴落は終わりではなく途中。",
    "だからこそ、安い時期を通るのも長期の前提。",
    "そう、暴落のあとに買えた人が一番強い。",
]
# E群: 比較遮断系 — 「他人と比べない」系（比較焦り系・SNS焦り向き）
_RESOLVE_COMPARE = [
    "だから、他人の速度はあなたの答えじゃない。",
    "結局、比べない日ほど続けやすい。",
    "やっぱり、見ない強さも長期では効く。",
    "つまり、自分のペースが一番の武器。",
    "だからこそ、隣を見ずに前を見る。",
...
_RESOLVE_RESTRAIN = [
    "結局、触らない仕組みのほうが崩れにくい。",
    "やっぱり、動かしすぎないほうが続けやすい。",
    "つまり、うまくやるより崩さないほうでいい。",
    "だから、迷う日ほど仕組みに戻ればいい。",
    "結局、ルールを減らしたほうがぶれにくい。",
    "やっぱり、触りすぎない形が残りやすい。",
]
...
★読み上げ適性:
  ...
  曲線A: hook（静かな違和感）→ empathy（整理）→ data（事実）→ resolve（肯定）→ closing
    例: 「退屈。」→「みんなそう感じる。」→「でも、20年続けた人、元本割れゼロ。」→「そう、退屈な投資が一番強い。」
...
良い例（全シーンが繋がっている）:
  hook:    「含み損。」
  empathy: 「あなただけじゃない。」
  data:    「でも、20年続けた人、元本割れゼロ。」
  resolve: 「だから、時間が最大の武器です。」
...
3. data（4秒）: 数字1つで希望を見せる。教えるな。
   ...
   悪い: data「20年続けた人、元本割れゼロ。」← 「でも」がなく、前シーンとの転換が不明確。
...
4. resolve（4秒）: dataを受けて、接続詞 + 結論フレーズで締める。
   ...
   良い: data「でも、20年続けた人、元本割れゼロ。」→ resolve「だから、時間が最大の武器。」
     ← 「20年でゼロ」→「だから時間」という因果関係が明確。
   悪い: data「でも、暴落後1年のリターン、平均+25%。」→ resolve「時間が最大の武器。」
     ← 暴落の話なのに「時間」の結論。繋がらない。
...
━━━ 出力 ━━━
JSON形式のみ（説明不要）:
{{"title": "含み損がつらい人へ", "description": "概要欄", "tags": ["タグ1", ...], "theme": "{theme_name}", "scenes": [{{"text": "含み損。", "slide_text": "含み損", "duration_sec": 1, "role": "hook"}}, {{"text": "あなただけじゃない。{opening}", "slide_text": "{opening}", "duration_sec": 3, "role": "empathy"}}, {{"text": "でも、20年続けた人、元本割れゼロ。", "slide_text": "20年で元本割れゼロ", "duration_sec": 4, "role": "data"}}, {{"text": "だから、時間が最大の武器。", "slide_text": "時間が最大の武器", "duration_sec": 4, "role": "resolve"}}, {{"text": "{closing}", "slide_text": "{closing_slide}", "duration_sec": 2, "role": "closing"}}]}}
"""
