...
4. resolve（4秒）: dataを受けて、接続詞 + 結論フレーズで締める。
   ...
   良い: data「でも、20年続けた人、元本割れゼロ。」→ resolve「だから、待てた人だけが数字に救われる。」
...
━━━ 出力 ━━━
JSON形式のみ（説明不要）:
{{"title": "含み損がつらい人へ", "description": "概要欄", "tags": ["タグ1", ...], "theme": "{theme_name}", "scenes": [{{"text": "含み損。", "slide_text": "含み損", "duration_sec": 1, "role": "hook"}}, {{"text": "あなただけじゃない。{opening}", "slide_text": "{opening}", "duration_sec": 3, "role": "empathy"}}, {{"text": "でも、20年続けた人、元本割れゼロ。", "slide_text": "20年で元本割れゼロ", "duration_sec": 4, "role": "data"}}, {{"text": "だから、待てた人だけが数字に救われる。", "slide_text": "待てた人が救われる", "duration_sec": 4, "role": "resolve"}}, {{"text": "{closing}", "slide_text": "{closing_slide}", "duration_sec": 2, "role": "closing"}}]}}
"""
