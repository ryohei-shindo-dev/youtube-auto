...
def cmd_apply_reschedule_plan(args):
    ...
    if getattr(args, "from_file", None):
        ...
        from note.schedule import load_schedule
...
def cmd_publish_queue(args):
    ...
    from note.schedule import find_duplicate_slots
...
def cmd_verify(args):
    """公開ページを検証する。"""
    from note.browser import _launch_browser, _close_browser
    from note.workflows import verify_and_report
