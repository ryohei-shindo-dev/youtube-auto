...
# サムネイル生成は slide_thumbnail.py に分離
# 循環import防止のため遅延re-export
def __getattr__(name):
    if name in ("generate_shorts_thumbnail", "generate_thumbnail_frame"):
        import slide_thumbnail
        return getattr(slide_thumbnail, name)
