...
**状態**: 2本目「積立3年目が一番つらい理由」を 2026-03-13 に公開済み。1本目は4再生で不振。ChatGPT方針: 2本目の反応を見るまで保留。
...
**状態**: 新プロンプト14本をキューに交互配置済み（2026-03-14）。旧2本:新1本の比率で投稿される。

**次のアクション**:
1. 新プロンプト動画の初速・再生数・いいね率を旧動画と比較
2. 2〜3週間後に効果判定（新プロンプトが優位なら次バッチも新プロンプトで生成）
3. 効果が出なければプロンプトを再調整
